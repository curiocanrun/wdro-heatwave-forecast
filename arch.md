...
This is the minimum cost of transporting probability mass from one distribution to another.
...
Future performance is bounded by historical performance plus the physical shift multiplied by how sensitive the model is.
